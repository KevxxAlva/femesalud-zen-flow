...
-- appointments (AgendaciÃ³n de citas)
...
-- clinical_notes (Notas clÃ­nicas libres)
...
-- consultations (Consultas mÃ©dicas estructuradas)
...
VALUES (
  ...
  '{"full_name":"Dra. Carli SolÃ© Aquino"}'::jsonb,
  'authenticated',
  'authenticated'
) ON CONFLICT (id) DO NOTHING;
...
VALUES (
  'e0000000-0000-0000-0000-000000000001',
  'Dra. Carli SolÃ© Aquino',
  'doctor@femesalud.example.com',
  'GinecologÃ­a y Obstetricia'
) ON CONFLICT (id) DO UPDATE SET specialty = 'GinecologÃ­a y Obstetricia';
...
VALUES (
  1,
  'Femesalud',
  'Calle las Flores entre GonzÃ¡lez PadrÃ³n y Shettino, NÃºmero 16.',
  'Valle de la Pascua, Estado GuÃ¡rico.',
...
ADD COLUMN IF NOT EXISTS cmc text;
...
-- ADD MISSING SEQUENCE USAGE
GRANT USAGE ON SEQUENCE public.historia_number_seq TO authenticated;
GRANT ALL ON SEQUENCE public.historia_number_seq TO service_role;
