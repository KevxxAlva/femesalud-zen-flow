    ...
    <div className="bg-card rounded-[2rem] p-6 shadow-sm min-h-[calc(100vh-8rem)] font-sans flex flex-col">
      ...
      <header className="flex flex-wrap items-center justify-between gap-4 mb-6">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-xl font-bold text-foreground">Servicios Médicos</h1>
        </div>
      ...
      <div className="flex flex-wrap items-center justify-between mb-4 border-b border-border/40 pb-4 mt-2">
        <div className="flex items-center gap-2 text-sm font-bold text-muted-foreground">
          <Stethoscope className="h-4 w-4" /> {filtered.length} servicios médicos
        </div>
        <div className="flex items-center gap-3">
        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="bg-muted text-[10px] font-bold text-muted-foreground uppercase tracking-wider">
              ...
              <th className="p-4">Nombre del Servicio <span className="ml-1">↕</span></th>
          ...
          <tbody className="text-sm">
            {isLoading ? (
              ...
              <tr><td colSpan={6} className="p-12 text-center text-muted-foreground font-medium">No se encontraron servicios médicos.</td></tr>
            ) : (
              paginated.map((s) => (
